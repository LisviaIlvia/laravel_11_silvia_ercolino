                ...
                <div class="col-12 col-md-8 col-lg-6">
                    <div class="card shadow-lg border-0">
                        ...
                        <div class="card-body bg-light">
                            <form action="{{ route('update.product', compact('product')) }}" method="POST"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" class="form-control rounded-3" id="description" rows="5" required>{{  $product->description }}</textarea>
                                </div>
                                ...
                                <!-- Pulsante Submit -->
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-info btn-lg rounded-pill">Modifica
                                        Prodotto</button>
                                </div>
                            </form>
                        </div>
